  ...
  <body class="easyui-layout">
 	...
 	<!--西-->
   	<div data-options="region:'west',border:false," style="background:#fff;width:20%;" >
		<!-- <div style="padding:3px;background-color: #00B4FA;border-radius: 5px;width: 80%;padding-left:5%;margin-left: 10%;">
			<button class="easyui-linkbutton" onclick="appendFront()" style="width: 95%;">添加前台</button>
		</div>
		<div style="padding:3px;border: 1px solid #B2D7F2;border-radius: 5px;width: 80%;padding-left:5%;margin-left: 10%;margin-top: 10%;">
			<button class="easyui-linkbutton" onclick="deleteFront()" style="width: 95%;">删除前台</button>
		</div>
   		...
   		<div style="width:100%;height:100%;float: right;padding: 5px;">
			...
			<script type="text/javascript">
				...
				function formatSex(value,row,index) {
					...
					$.ajax({
						// 我是从@RequestMapping(value="/FrontManagement")中拿的当前数据库最新数据
						url: '../DistinguishedQuality360Hotel/administrator/FrontManagement',
						type: 'post',
						data: {},
						dataType:'json',
						async: false,//同步
						...
						$.ajax({
							...
							error:function(xhr,type,errorThrown){
								$.messager.alert('提示','保存失败！','info',
									function(){location.href='../DistinguishedQuality360Hotel/administrator/FrontManagement'});
								console.log(errorThrown);
							}
	                	});
					}
